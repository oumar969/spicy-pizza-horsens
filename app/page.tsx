...
export default function Home() {
  ...
  return <main>
    ...
    <section className="food-control" aria-label="Fødevarekontrol"><div className="smiley-mark" aria-hidden="true">☺</div><div><span>Offentlig fødevarekontrol</span><h2>Se vores kontrolrapport</h2><p>Rapporten åbner direkte hos Fødevarestyrelsens officielle Find Smiley-side.</p></div><a href="https://www.findsmiley.dk/Sider/VirkSide.aspx?virk=1279108" target="_blank" rel="noopener noreferrer">Se kontrolrapport <b>↗</b></a></section>
